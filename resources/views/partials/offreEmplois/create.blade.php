        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Créer une nouvelle offre d'emploi</h2>
                    <p class="text-gray-600">Remplissez les informations ci-dessous pour publier votre offre d'emploi.</p>
                </div>

                <form method="POST" action="{{ route('offres-emplois.store') }}" class="p-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <select name="type_contrat" 
                                ...
                                <option value="formation" {{ old('type_contrat') == 'formation' ? 'selected' : '' }}>Formation</option>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Décrivez le poste, les responsabilités principales...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="missions_principales" 
                                  ...
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Listez les principales missions et responsabilités...">{{ old('missions_principales') }}</textarea>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="avantages_offerts" 
                                  ...
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Décrivez les avantages offerts (télétravail, avantages sociaux, etc.)">{{ old('avantages_offerts') }}</textarea>
                    </div>
