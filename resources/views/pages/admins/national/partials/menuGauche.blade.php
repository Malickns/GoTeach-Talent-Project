<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{ route('pages.admins.national.dashboard') }}" class="navbar-brand mx-4 mb-3">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            ...
            <div class="ms-3">
                ...
                <span>Admin national</span>
            </div>
        </div>
        <div class="navbar-nav w-100">
            <a href="{{ route('pages.admins.national.dashboard') }}" class="nav-item nav-link {{ request()->routeIs('pages.admins.national.dashboard') ? 'active' : '' }}"><i class="fa fa-bolt me-2"></i>Nouveautés</a>
            <a href="{{ route('admin.national.jeunes.index') }}" class="nav-item nav-link {{ request()->routeIs('admin.national.jeunes.*') ? 'active' : '' }}"><i class="fa fa-users me-2"></i>Jeunes</a>
